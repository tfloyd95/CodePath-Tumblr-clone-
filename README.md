...
GIF created with [LiceCap] https://github.com/tfloyd95/CodePath-Tumblr-clone-/blob/master/Tumblr(clone).gif.
...
*I added the comments and blog name to the detail view 
* I added pubish dates
